...
from .commands import update_proposals, update_srccon_schedule, update_srccon_lead_schedule
...
KNOWN_COMMANDS = {
    'membot': ['show',],
    'hey bmo': ['build srccon schedule', 'build srcconlead schedule', 'build srccon:lead schedule', 'update srccon proposals'],
}
